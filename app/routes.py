...
temp_model = mlflow.pyfunc.load_model(f"models:/{os.getenv('TEMP_MODEL_NAME')}@prod")
hum_model = mlflow.pyfunc.load_model(f"models:/{os.getenv('HUMIDITY_MODEL_NAME')}@prod")
